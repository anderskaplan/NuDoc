namespace NuDoc
{
    ...
    {
        /// <summary>
        /// Gets the full display name of a type, with namespace.
        /// </summary>
        string GetDisplayName(Type type);

        /// <summary>
        /// Gets the short display name of a type, without namespace and other details.
        /// </summary>
        string GetShortDisplayName(Type type);
